...
def test_intensity_measurement_on_normals():
    ...
    from napari_stress import frame_by_frame, measurements, sample_data, vectors
...
def test_curvature3():
    ...
    from napari_stress import approximation, get_droplet_point_cloud_4d, measurements
