...
def stress_spherical_harmonics_expansion(points: PointsData,
    ...
    X_fit_sph = sph_f.sph_func(X_fit_sph_coef_mat, max_degree)
    Y_fit_sph = sph_f.sph_func(Y_fit_sph_coef_mat, max_degree)
    Z_fit_sph = sph_f.sph_func(Z_fit_sph_coef_mat, max_degree)
